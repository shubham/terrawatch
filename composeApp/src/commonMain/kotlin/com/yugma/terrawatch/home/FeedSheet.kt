...
private fun FeedSheetHeader(isLive: Boolean, newCount: Int, modifier: Modifier = Modifier) {
    Row(
        ...
        if (isLive) {
            // STATIC dot this task — Task 10 owns the pulsing animation (see this file's kdoc /
            // the Task 9 brief: "pulsing dot placeholder STATIC this task").
            Box(Modifier.size(8.dp).background(TerraColors.Safe, CircleShape))
            Text(
                text = "LIVE",
